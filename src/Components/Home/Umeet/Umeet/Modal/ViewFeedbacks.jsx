...
const ViewFeedbacks = ({ onClose }) => {
  return (
    <section
      className="absolut z-10 fixed top-7 left-0 h-full w-full flex justify-center items-center"
