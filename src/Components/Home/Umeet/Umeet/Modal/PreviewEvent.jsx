      ...
      <div className="w-[96%] md:w-[55%] lg:w-[40%] xl:w-[37%] h-[96%] bg-white rounded-xl p-3">
        ...
        <section className="mt-1 h-[92%] overflow-y-scroll">
          ...
          {eventMode == "location" && (
            <div className={`flex mb-3`}>
              ...
              <div className="w-2/3 flex">
                :<div className="ml-3 font-bold">{formState.eventAddress}</div>
          ...
          <div className="flex pb-4">
            ...
            <span className="w-2/3">
              :<span className="ml-3 font-bold">{formState.aboutevent}</span>
            </span>
          </div>
        </section>
      </div>
