...
const RvspModal = ({ onClose }) => {
  ...
  return (
    <section
      className="absolut z-20 fixed top-0 left-0 h-full w-full flex justify-center items-center"
      ...
      <div className="w-[86%] md:w-[45%] lg:w-[33%] xl:w-[26%] h-[82%] lg:h-[77%] xl:h-[78%] flex flex-col justify-between p-5 bg-white md:ml-[9%] mt-[12%] md:mt-[9%] xl:mt-[4%] rounded-2xl">
        <section>
          ...
          <div className="relative">
            <select
              ...
              className="border bg-white border-gray-300 w-full py-2 pl-3 pr-10 text-gray-700 focus:outline-none focus:border-blue-500"
            >
              <option value="veg">Veg</option>
              <option value="nonveg">Non-Veg</option>
            </select>
            <label className="absolute -top-1 left-2 -mt-px px-1 bg-white text-gray-600 text-xs">
              Food Preference
            </label>
          </div>
        ...
        <section>
          <div className="flex py-1 lg:py-2">
            <button
              onClick={onClose}
              className="px-5 w-1/2 py-2 border boredr-[#649B8E] text-[#649B8E]"
            >
              Cancel
            </button>
            <button
              onClick={handleInvitees}
              className="px-5 py-2 w-1/2 text-white border bg-[#649B8E]"
            >
              Save
            </button>
          </div>
