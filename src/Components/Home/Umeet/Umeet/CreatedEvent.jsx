      ...
      <div className="">
        <div className="flex mb-3">
          ...
          <span className="w-2/3">
            :<span className="ml-3 font-semibold">Ravichandra Ashwin</span>
          </span>
        </div>
        <div className="flex mb-3">
          <span className="w-1/3">Mobile No</span>
          <span className="w-2/3">
            :<span className="ml-3 font-bold">+1 8146369384</span>
          </span>
        </div>
        <div className="flex mb-3">
        ...
        <div className="flex mb-3">
          ...
          <div className="w-2/3 flex">
            ...
            <div className="ml-3 font-bold">
              168, Addrss Living, South Africa - 626987
            </div>
          </div>
        </div>
        <div className="flex mb-3">
          ...
          <span className="w-2/3">
            ...
            <span className="ml-3 font-bold">
              06:00 pm - 12.00 pm, 28th Apr 2023
            </span>
          </span>
        </div>
        <div className="flex pb-4 border-b-2 border-gray-300">
          ...
          <span className="w-2/3">
            :<span className="ml-3 font-bold">Go like a fire</span>
          </span>
        </div>
      </div>
