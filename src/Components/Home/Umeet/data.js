...
export const selectEventList = [
  {
    ...
    title: "Personal",
    events:
      "Birthday, ReUnion, Anniversary etc.. With Friends, Relatives, Classmates & Officemates",
  },
  {
    img: Public,
    title: "Public",
    events:
      "Shop Opening, Product Launch, Public Meetings etc.. By City, State & Country",
  },
  {
    img: Political,
    title: "Political",
    events:
      "Party Meeting, Feedbacks With Party or Candidates etc.. By Assembly, Lok Sabha, State & Country",
  },
];
