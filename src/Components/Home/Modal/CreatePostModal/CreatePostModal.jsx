        ...
        <div className="">
          <div className="lg:w-[75%] xl:w-[70%] ">
            ...
            <section className="flex items-center relative ">
              ...
              <Dropdown
                ...
                heading={
                  <Typography disabled variant='small' className='p-3 w-full bg-gray-300' >Manage who can see your post</Typography>
                }
                keyName="name"
              />
              {/* {alert && (
          ...
          <div className="leftSide">
            ...
            <div className="comment">
              <textarea
                value={postContent}
                onChange={(e) => e.target.value.length < 800 &&
                  handlePostContent(e)
                }
