      ...
      <>
         ...
         <section className=' my-2 flex items-center text-black'>
            <div className='flex justify-center items-center rounded-md bg-white'>
               <input value={commentText} name='commentText' placeholder='Add comment...' className='w-full h-9 rounded-md outline-none pl-3 whitespace-break-spaces' onChange={handleChange} />
